...
#include "log.h"
#include "config.h"
//#include "/home/oracle/gway/libs/libtinyxml/tinyxml.h"
#include"tinyxml.h"
const static int DEFAULT_WORK_NUM = 12;
...
int Config::read_config(const char *file_name)
{
    ...
    logdbg("keep-alive:%d\n", m_keep_alive);
// m_ep_events = (struct epoll_event *)malloc((m_ep_max_poll, sizeof(struct epoll_event))*500);
